    ...
    public int[][] assignBitmap(Bitmap bitmap) {
        switch (bitmap) {
            case PIC_LOGO: {
                ...
                return ImageCreator.stringsToArray(
            ...
            case SHOP_COIN: {
                ...
                return ImageCreator.stringsToArray("0110", "1112", "1112", "1112", "1122", "0220");
            }
            case MENU_ARROW: {
                colors = new Color[]{Color.NONE, Color.YELLOW, Color.WHITE};
                return ImageCreator.stringsToArray("11000", "01100", "00110", "00011", "00110", "01100", "11000");
            }
            case MENU_DIFFICULTY_BAR: {
                colors = new Color[]{Color.NONE, Color.GREEN, Color.BLACK};
                return ImageCreator.stringsToArray("020", "212", "212", "212", "212", "212", "020");
            }
            case WIN_MENU: {
                colors = new Color[]{
                        Color.NONE,
                ...
                return ImageCreator.createWindowBitmap(100, 100, false, true);
            }
            case WIN_SHOP: {
                colors = new Color[]{
                        Color.NONE,
                ...
                return ImageCreator.createWindowBitmap(80, 80, true, true);
            }
            case WIN_SHOP_HEADER_FOOTER: {
                colors = new Color[]{
                        ...
                        Color.BLACK,
                        Theme.SHOP_BORDER.getColor()};
                return ImageCreator.createWindowBitmap(80, 12, false, true);
            }
            case SHOP_ITEM_FRAME: {
                ...
                return ImageCreator.createWindowBitmap(20, 20, true, true);
            }
            case SHOP_ITEM_FRAME_PRESSED: {
                ...
                return ImageCreator.createWindowBitmap(20, 20, false, true);
            }
            case WIN_VICTORY:
            case WIN_GAME_OVER: {
                colors = new Color[]{
                ...
                return ImageCreator.createWindowBitmap(70, 35, true, true);
            }
            case BUTTON_OK: {
                colors = new Color[]{Color.NONE, Color.SADDLEBROWN, Color.BLACK, Color.BURLYWOOD};
                return ImageCreator.createWindowBitmap(13, 9, true, true);
            }
            case BUTTON_CLOSE: {
                colors = new Color[]{Color.NONE, Color.SADDLEBROWN, Color.BLACK, Color.BURLYWOOD};
                return ImageCreator.createWindowBitmap(9, 9, true, true);
            }
            case MENU_SWITCH: {
                colors = new Color[]{Color.NONE, Color.RED, Color.BLACK, Color.YELLOW};
                return ImageCreator.createWindowBitmap(4, 7, false, true);
            }
            case MENU_SWITCH_RAIL: {
                colors = new Color[]{Color.NONE, Color.BLACK, Color.NONE, Color.NONE};
                return ImageCreator.createWindowBitmap(12, 3, false, false);
            }
            ...
            case MENU_THEME_PALETTE: {
                ...
                return ImageCreator.createWindowBitmap(10, 10, false, true);
            }
            case SHOP_DICE_1: {
            ...
            default: {
                ...
                return ImageCreator.stringsToArray("1");
            }
        }
    }
}
