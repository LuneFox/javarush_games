...
public class Tutorial1 extends Stage {
    public Tutorial1() {
    ...
    protected void createOrbs() {
        orbs.add(Orb.create(10, 10, Element.NEUTRAL));
        orbs.add(Orb.create(15, 15, Element.NEUTRAL));
        orbs.add(Orb.create(20, 20, Element.NEUTRAL));
        orbs.add(Orb.create(25, 25, Element.NEUTRAL));
    }
    ...
    protected void createMessages() {
        briefingMessage = name +
                "\nAlchemy Snake feeds on Orbs of Wisdom." +
                "\nThey look like this: " + Sign.getSign(Sign.ORB_NEUTRAL) +
                "\nCollect 3 of them!" +
                "\n\n~ PRESS SPACE TO START ~";
        completeMessage = "TUTORIAL 1 COMPLETE!\nGOOD JOB!" +
