...
public class EmptyStage extends Stage {
    ...
    protected void createOrbs() {
        orbs.add(Orb.create(10, 10, Element.WATER));
        orbs.add(Orb.create(12, 12, Element.FIRE));
        orbs.add(Orb.create(14, 14, Element.EARTH));
        orbs.add(Orb.create(16, 16, Element.AIR));
        orbs.add(Orb.create(18, 18, Element.ALMIGHTY));
    }

    @Override
    protected void createWormHoles() {
        wormHoles.add(new WormHole(0, 0, 31, 31));
    }

    @Override
    protected void defineSnakeStartingPlace() {
        snakeStartPlace = new Coordinate(7, 7);
        snakeStartDirection = Direction.DOWN;
    }

    @Override
    protected void createMessages() {
        briefingMessage = "TESTING STAGE";
        completeMessage = "TEST COMPLETE";
    }
