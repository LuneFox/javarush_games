...
public abstract class Image {
    final protected RacerGame GAME;                // game instance to be drawn into
    private int drawX;
    ...
    protected Image(Bitmap bitmap, RacerGame game, int drawX, int drawY) { // constructor with setting position at once
    ...
    Image(Bitmap bitmap, RacerGame game) { // constructor without setting position (for loading images in memory)
        this.colors = new Color[2];
        this.bitmapData = assignBitmap(bitmap);
        this.GAME = game;
    }
